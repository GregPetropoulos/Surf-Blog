...
const highlightedArticleData = formattedData.find(item=> item.isHighlightArticle)
const featuredArticlesData = formattedData.filter(item => !item.isHighlightArticle)
